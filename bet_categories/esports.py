...
from bet_categories.bet_category_constants import esports_team_dict


class Esports(BetCategory):
	...
	def fix_team_names(self, team_name):
		if team_name in esports_team_dict:
			team_name = esports_team_dict[team_name]
